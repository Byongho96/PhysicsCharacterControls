  ...
  (function () {
    ...
    for (B = H.length; l < B; ++l)
      (function () {
        ...
        g.src =
          'https://cdn.jsdelivr.net/gh/google/code-prettify@master/loader/lang-' + encodeURIComponent(H[l]) + '.js';
        N.insertBefore(g, N.firstChild);
      })(H[l]);
    for (var S = H.length, F = [], l = 0, B = P.length; l < B; ++l)
      F.push(
        'https://cdn.jsdelivr.net/gh/google/code-prettify@master/loader/skins/' + encodeURIComponent(P[l]) + '.css',
      );
    ...
    var ca = (function () {
      ...
      (function () {
          ...
          function c(e) {
            ...
            for (var a = a ? 1 : 0, h = c.length; a < h; ++a) {
              ...
              if (/\\[bdsw]/i.test(m)) b.push(m);
                ...
                65 > p ||
                  122 < m ||
                  (65 > p || 90 < m || e.push([Math.max(65, m) | 32, Math.min(p, 90) | 32]),
                  97 > p || 122 < m || e.push([Math.max(97, m) & -33, Math.min(p, 122) & -33]));
              }
            }
            e.sort(function (e, a) {
          ...
          function g(e) {
            ...
            for (m = h = 0; h < b; ++h)
              (p = a[h]),
                '(' === p
                  ? (++m, d[m] || (a[h] = '(?:'))
                  : '\\' === p.charAt(0) && (p = +p.substring(1)) && p <= m && (a[h] = '\\' + d[p]);
        ...
        function E(a, d) {
          function f(a) {
            for (
              var q = a.i, r = a.h, b = [q, 'pln'], t = 0, A = a.a.match(g) || [], u = {}, e = 0, l = A.length;
              e < l;
              ++e
            ) {
              var D = A[e],
        ...
        function B(a, d, f) {
          ...
          for (
            var r = /(?:^|\s)nocode(?:\s|$)/, n = /\r\n?|\n/, q = a.ownerDocument, k = q.createElement('li');
            a.firstChild;
        ...
        n(v({ keywords: M, hashComments: !0, cStyleComments: !0, verbatimStrings: !0, types: P }), ['cs']);
        ...
        var U = (Q.PR = {
            ...
            prettyPrint: (g = function (a, d) {
              function f() {
                for (
                  var c = Q.PR_SHOULD_USE_CONTINUATION ? b.now() + 250 : Infinity;
                  t < r.length && b.now() < c;
                  t++
                ) {
                  ...
                  if ((k !== h || u.test(n)) && !e.test(n)) {
                    ...
                    if (!q) {
                      ...
                      y = k.linenums;
                      (y = 'true' === y || +y) ||
                        (y = (y = n.match(/\blinenums\b(?::(\d+))?/)) ? (y[1] && y[1].length ? +y[1] : !0) : !1);
                      y && B(d, y, l);
                      H({ j: q, h: d, m: y, l: l, a: null, i: null, c: null, g: null });
                    }
                  }
                }
              ...
              for (
                var c = d || document.body,
                  ...
                  c = [c.getElementsByTagName('pre'), c.getElementsByTagName('code'), c.getElementsByTagName('xmp')],
                  r = [],
                  k = 0;
                k < c.length;
                ++k
