import { AnimationClip, Camera, Object3D, Vector3, Vector3 } from 'three';
 ...
 */
class MouseDragObjectRotationControls extends PhysicsControls {
  ...
  private _tempVector4: Vector3 = new Vector3();
  ...
  /**
   * Gets the position the object should be facing.
   * @returns  position vector to look at.
   */
  private getTargetVector(): Vector3 {
    this._tempVector4.addVectors(this.getForwardVector(), this.object.position);
    return this._tempVector4;
  }
  ...
  private updateControls(delta: number) {
    ...
    this.object.lookAt(this.getTargetVector());
...
export { MouseDragObjectRotationControls };
