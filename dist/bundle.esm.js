import { Vector3, Plane, Line3, Sphere, Box3, Triangle, Layers, Controls, AnimationObjectGroup, AnimationMixer, Group, CapsuleGeometry, LineSegments, LineBasicMaterial, BoxGeometry } from 'three';
...
class PhysicsControls extends Controls {
    constructor(object, domElement, world, physicsOptions) {
        ...
        this._collider = new Capsule(new Vector3(0, this.radius, 0), new Vector3(0, this.height - this.radius, 0), this.radius);
...
class PhysicsControlsHelper extends Group {
    constructor(controls, color = 0xffffff) {
        ...
        const capsuleGeometry = new CapsuleGeometry(controls.radius, controls.height - 2 * controls.radius);
...
export { KeyboardRotationControls, PhysicsControlsHelper };
